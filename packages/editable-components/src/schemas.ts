...
export const components: InternalRenderableComponentDefinition[] = [
  // root sections
...

  {
    ...
    editing: ({ values, editingInfo }) => {
      ...
      if (isNoneMode) {
        ...
        newFields = [...fieldsBefore, ...card2FieldPortalsAll, ...fieldsAfter];
...
export const schemas = components;
export const builtinEditableComponentsDefinitions = components;
