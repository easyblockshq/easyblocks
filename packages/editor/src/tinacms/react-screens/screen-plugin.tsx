...
import { TinaPlugin } from "@easyblocks/app-utils";
 ...
 */
export interface ScreenPlugin<ExtraProps = Record<string, unknown>>
  extends TinaPlugin {
  __type: "screen";
 ...
 */
export interface ScreenOptions<ExtraProps = Record<string, unknown>> {
  name: string;
