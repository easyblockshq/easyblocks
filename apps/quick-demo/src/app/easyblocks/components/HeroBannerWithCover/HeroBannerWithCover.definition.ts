...
export const heroBannerWithCoverDefinition: NoCodeComponentDefinition = {
  ...
  styles: (values: any) => {
    ...
    const DEBUG_BORDER = `1px blue dashed`;

    return {
      // debug items
      DebugLeftContainerLine: box({
        display: SHOULD_DEBUG ? "block" : "none",
        position: "absolute",
        left: isFullWidth ? paddingOnMarginSide : margin,
        top: 0,
        height: "100%",
        width: "1px",
        borderLeft: DEBUG_BORDER,
      }),
      DebugRightContainerLine: box({
        display: SHOULD_DEBUG ? "block" : "none",
        position: "absolute",
        right: isFullWidth ? paddingOnMarginSide : margin,
        top: 0,
        height: "100%",
        width: "1px",
        borderLeft: DEBUG_BORDER,
      ...
      Root: box({
        ...
        position: "relative",
        border: SHOULD_DEBUG ? DEBUG_BORDER : "initial",
      }),
      Container: box({
        margin: "0 auto",
